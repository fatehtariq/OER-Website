...
<body>
  ...
  <div class="w3-bar w3-card-4 w3-red w3-round-large">
    ...
    <i class="material-icons w3-right w3-xxlarge w3-hover-opacity">search</i>
  </div>
  ...
  <!--About and NewsLetter-->
   <div class="w3-bar w3-center">
    ...
    <button class= "w3-button w3-light-grey w3-round-large" style="margin-bottom: 3.50%;">Submit</button>
    </div>
  </div>
